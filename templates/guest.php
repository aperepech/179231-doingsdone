...
<head>
    <meta charset="UTF-8">
    <title>Анонимный пользователь</title>
    <link rel="stylesheet" href="css/normalize.css">
    <link rel="stylesheet" href="css/style.css">
</head>

<body class="body-background <?php echo $body_classes; ?>"><!--class="overlay"-->
...
<footer class="main-footer">
    <div class="container">
        ...
        <a class="main-footer__button button button--plus" href="index.php?login">Добавить задачу</a>
...
<div class="modal" <?php echo $hidden; ?>>
    ...
    <form class="form" action="index.php?login" method="post">
        ...
        <div class="form__row">
            <label class="checkbox">
                <input name="remember" class="checkbox__input visually-hidden" type="checkbox" checked>
